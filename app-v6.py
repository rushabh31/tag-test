...
class SemanticImageMatcher:
    ...
    def calculate_image_relevance(self, query: str, image: EnhancedImageData) -> float:
        ...
        try:
            ...
            logger.error(f"Error calculating image relevance with VertexAI: {e}")
            return self._keyword_similarity(query, image)
...
class AdvancedPDFProcessor:
    ...
    def __init__(self, gen_ai_provider: VertexGenAI):
        ...
        self.image_matcher = SemanticImageMatcher(gen_ai_provider)
...
class VertexAIEmbeddings(Embeddings):
    """Embeddings class using VertexAI."""
    
    def __init__(self, gen_ai_provider: VertexGenAI, model_name: str = "text-embedding-004"):
        self.gen_ai_provider = gen_ai_provider
...
class HybridRetriever:
    ...
    def __init__(self, documents: List[Document] = None, gen_ai_provider: VertexGenAI = None):
        ...
        # Custom Reranking
        self.reranker = CustomReranker(gen_ai_provider) if gen_ai_provider else None
...
class UltraAccurateRAGSystem:
    ...
    def __init__(self, gen_ai_provider: VertexGenAI = None):
        logger.info("Initializing UltraAccurateRAGSystem...")
        
        self.gen_ai_provider = gen_ai_provider
        self.processor = AdvancedPDFProcessor(gen_ai_provider) if gen_ai_provider else None
        self.documents = {}
            ...
            with gr.Column(elem_classes=["main-container"]):
                ...
                <div class="logo-container">
                    ...
                    <div class="logo-text">
                        ...
                        <div class="accuracy-badge">Enhanced with VertexAI Embeddings & Source Inspector</div>
                    </div>
                </div>
                """)
                ...
                with gr.Column(elem_classes=["chat-container"]):
                    ...
                    status_display = gr.Markdown("🤖 **Status:** Upload documents to begin with VertexAI-powered analysis.")
            ...
            def handle_upload_files(files, is_initialized):
                if not is_initialized:
                    try:
                        ...
                        return f"❌ Initialization error with VertexAI: {str(e)}", False, gr.update(visible=False)

                if not files:
                    return "✅ System initialized with VertexAI. Ready for document processing.", is_initialized, gr.update(visible=False)
...
def main():
    ...
    print("🎯 Starting Ultra-Accurate RAG System with VertexAI Embeddings & Chat Interface")
    ...
    print("- 🤖 AI Provider: VertexAI with native embeddings")
    print("- 🔍 Hybrid retrieval: Dense (HNSW) + Sparse (BM25)")
    print("- 🎯 Custom reranker with VertexAI semantic similarity & keyword matching")
    print("- 🖼️ Semantic image-text matching with VertexAI embeddings")
